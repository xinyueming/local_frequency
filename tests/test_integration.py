...
class TestEndToEndPipeline:
    ...
    def test_full_pipeline(self, mock_build_db, mock_cnv, MockClient, tmp_path):
        ...
        mock_ssh.walk_remote_dir.return_value = [
            "/data/a/b/proj001/sample1.hg38_multianno.filter.xls",
            "/data/a/b/proj001/sample1.total.fusion.xls",
            "/data/a/b/proj001/sample1.tsv.redup.xls",
        ]
        ...
        p.source_dict = {"proj001": {
            ".filter.xls": ["/data/a/b/proj001/sample1.hg38_multianno.filter.xls"],
            ".total.fusion.xls": ["/data/a/b/proj001/sample1.total.fusion.xls"],
            ".tsv.redup.xls": ["/data/a/b/proj001/sample1.tsv.redup.xls"],
        }}
